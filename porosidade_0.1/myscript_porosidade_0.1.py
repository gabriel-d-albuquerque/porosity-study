...
s.CircleByCenterPerimeter(center=(0.5, 0.5), point1=(0.678, 0.5))
...
# Creating job
mdb.Job(name='porosidade_1', model='Model-1', description='', type=ANALYSIS, 
...
# Save the model
mdb.saveAs(pathName='./estudo_porosidade_0.1.cae')

# Submit job
mdb.jobs['porosidade_1'].submit(consistencyChecking=OFF)
...
o3 = session.openOdb(
    name='C:/Users/Gabriel Delgado/OneDrive/Universidade/IC/HelloAbaqus/tarefa2/porosidade_0.1/porosidade_1.odb')
#: Model: C:/Users/Gabriel Delgado/OneDrive/Universidade/IC/HelloAbaqus/tarefa2/porosidade_0.1/porosidade_1.odb
