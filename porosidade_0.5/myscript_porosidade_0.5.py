...
s.CircleByCenterPerimeter(center=(0.5, 0.5), point1=(0.899, 0.5))
...
# Creating job
mdb.Job(name='porosidade_5', model='Model-1', description='', type=ANALYSIS, 
...
# Save the model
mdb.saveAs(pathName='./estudo_porosidade_0.5.cae')

# Submit job
mdb.jobs['porosidade_5'].submit(consistencyChecking=OFF)
...
o3 = session.openOdb(
    name='C:/Users/Gabriel Delgado/OneDrive/Universidade/IC/HelloAbaqus/tarefa2/porosidade_0.5/porosidade_5.odb')
#: Model: C:/Users/Gabriel Delgado/OneDrive/Universidade/IC/HelloAbaqus/tarefa2/porosidade_0.5/porosidade_5.odb
